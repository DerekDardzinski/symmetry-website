    ...
    <div className="about-grid">
      <div>
        ...
        <p className="about-text">
          ...
          3D visualizations were created using react-three-fiber and drei, which
          are React renderers and abstractions of the popular 3D animation
          library THREE.js. All code is available on{" "}
          <a
        ...
        <p className="about-text">
          ...
          Carnegie Mellon University and is a recreation of his novel method of
          3D point group visualizations which was originally created using a
          ray-tracing program. To understand more about the motivation behind
          this work, please refer to the following paper:
          <br />
